...
#ResNet50 offers deeper representations and has outperformed many classic CNNs in medical image classification.
...
# Save Model
model.save('ham10000_skin_cnn_restnet50.h5')
